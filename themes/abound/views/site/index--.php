...
$gridDataProviderEvacuees = new CArrayDataProvider(array(
    array('id'=>1, 'firstName'=>'Mark', 'lastName'=>'Otto', 'language'=>'CSS','usage'=>'<span class="inlinebar">1,3,4,5,3,5</span>'),
    array('id'=>2, 'firstName'=>'Jacob', 'lastName'=>'Thornton', 'language'=>'JavaScript','usage'=>'<span class="inlinebar">1,3,16,5,12,5</span>'),
    array('id'=>3, 'firstName'=>'Stu', 'lastName'=>'Dent', 'language'=>'HTML','usage'=>'<span class="inlinebar">1,4,4,7,5,9,10</span>'),
	array('id'=>4, 'firstName'=>'Jacob', 'lastName'=>'Thornton', 'language'=>'JavaScript','usage'=>'<span class="inlinebar">1,3,16,5,12,5</span>'),
...
<div class="row-fluid">
	...
	<div class="span6">
		 <?php $this->widget('zii.widgets.grid.CGridView', array(
			/*'type'=>'striped bordered condensed',*/
			'htmlOptions'=>array('class'=>'table table-striped table-bordered table-condensed'),
			'dataProvider'=>$gridDataProviderEvacuees,
			'template'=>"{items}",
			'columns'=>array(
				array('name'=>'id', 'header'=>'#'),
...
<div>
	<center>
		...
		<object width="500" height="375">  
			<param name="src" value="http://pregi.net/player/player.swf?streamer=rtmp://live.pregi.net/oflaDemo&amp;file=livestream.flv&amp;autostart=false" />
			<param name="allowfullscreen" value="true" />
				<embed width="500" height="375" type="application/x-shockwave-flash" src="http://pregi.net/player/player.swf?streamer=rtmp://live.pregi.net/oflaDemo&amp;file=region9.flv&amp;autostart=true" allowfullscreen="false" />
		</object>
	</center>
</div>        
