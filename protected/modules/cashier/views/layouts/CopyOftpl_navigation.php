<div class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
          ...
          <a class="brand" href="#">DSWD - Disaster Management Information System</a>
          ...
          <div class="nav-collapse">
			<?php $this->widget('zii.widgets.CMenu',array(
                    ...
                    'items'=>array(
						...
						//array('label'=>'HH-Consolidated', 'url'=>array('/headwithdup/admin')),
						//array('label'=>'Consolidated', 'url'=>array('/consolidated/admin')),
						array('label'=>'Evacuees', 'url'=>array('/evacuee/admin')),
						//array('label'=>'Evac-Conso', 'url'=>array('/individualwithdup/admin')),
                        ...
                        'items'=>array(
							...
							//array('label'=>'Gii generated', 'url'=>array('gii/default/login')),
							//array('label'=>'Users <span class="badge badge-info pull-right">'.User::model()->count().'</span>', 'url'=>array('user/admin')),
