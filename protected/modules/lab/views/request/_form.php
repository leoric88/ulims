...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $model->isNewRecord ? $form->dropDownList($model,'labId', Lab::listLabName(), array('tabindex'=>"7", 'style'=>'width: 220px;','empty'=>'Please select lab...')) : $form->dropDownList($model,'labId', Lab::listdata(), array('tabindex'=>"7", 'style'=>'display: none;')); ?>
